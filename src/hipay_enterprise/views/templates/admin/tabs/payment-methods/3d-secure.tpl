    ...
    <form method="post" class="defaultForm form-horizontal"
        ...
        <div class="panel" id="fieldset_0">
            ...
            <div class="panel-footer">
                <button type="submit" class="btn btn-default btn btn-default pull-right" name="submit3DSecure"><i
                            class="process-icon-save"></i> {l s='Save' mod='hipay_enterprise'}</button>
            </div>
        </div><!-- /.form-wrapper -->
    </form>
</div>
