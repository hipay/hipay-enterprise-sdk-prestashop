...
<div class="panel" id="panel-faq">
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-question">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" aria-expanded="false"
                href="#faq__collapseOne"><i class="icon-question-circle"></i>
                {l s='How do I get my HiPay API credentials ?' mod='hipay_enterprise'}
                <i class="icon-arrow-circle-o-down"></i></a>
        </div>
        <div id="faq__collapseOne" class="panel-collapse collapse">
            <div class="panel-body">
                <p>
                    {l s='You need to generate' mod='hipay_enterprise'}
                    <strong>{l s='API credentials' mod='hipay_enterprise'}</strong>
                    {l s='to send requests to the HiPay Enterprise platform. To do so, go to the "Integration" section of your HiPay Enterprise back office, then to "Security Settings".' mod='hipay_enterprise'}
                </p>
                <p>
                ...
                <ul>
                    ...
                    <li>{l s='Click on the edit icon next to the credentials you want to use.' mod='hipay_enterprise'}
                    </li>
                </ul>
                </p>
                <p>
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-question">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" aria-expanded="false"
                href="#faq__collapseTwo"><i class="icon-question-circle"></i>
                {l s='How do I fill in the API IDs in the module ?' mod='hipay_enterprise'}
                <i class="icon-arrow-circle-o-down"></i></a>
        </div>
        <div id="faq__collapseTwo" class="panel-collapse collapse">
            <div class="panel-body">
                <p>
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-question">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" aria-expanded="false"
                href="#faq__collapseThree"><i class="icon-question-circle"></i>
                {l s=' Why do orders never reach the “Accepted Payment” status?' mod='hipay_enterprise'}
                <i class="icon-arrow-circle-o-down"></i></a>
        </div>
        <div id="faq__collapseThree" class="panel-collapse collapse">
            <div class="panel-body">
                <p>
                ...
                <ul>
                    <li>{l s='Notification URL: http: // www.[Your-domain.com] /index.php?fc=module&module=hipay_enterprise&controller=notify' mod='hipay_enterprise'}
                    </li>
                    <li>{l s='Request method: HTTP POST' mod='hipay_enterprise'}</li>
                    <li>{l s='I want to be notified for the following transaction statuses: ALL' mod='hipay_enterprise'}
                    </li>
                </ul>
                </p>
                <p>
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-question">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" aria-expanded="false"
                href="#faq__collapseFour"><i class="icon-question-circle"></i>
                {l s='What to do when payment errors occur ?' mod='hipay_enterprise'}
                <i class="icon-arrow-circle-o-down"></i></a>
        </div>
        <div id="faq__collapseFour" class="panel-collapse collapse">
            <div class="panel-body">
                <ul>
                    <li>{l s='Make sure that your credentials are correctly set and that the module is in the mode you want (Test or Production).' mod='hipay_enterprise'}
                    </li>
                    <li>{l s='Check that the related payment methods are activated in your contract(s).' mod='hipay_enterprise'}
                    </li>
                    <li>{l s='Check the version of the installed module, and upgrade the module if the version is old.' mod='hipay_enterprise'}
                    </li>
                    <li>{l s='Check HiPay logs to see if any errors appear. Then send these logs to the HiPay Support team.' mod='hipay_enterprise'}
                    </li>
                    <li>{l s='Check that your servers are not behind a proxy. If so, provide the proxy information in the module configuration.' mod='hipay_enterprise'}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-question">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" aria-expanded="false"
                href="#faq__collapseFive"><i class="icon-question-circle"></i>
                {l s='How come my payment method(s) do(es) not appear in the order funnel ?' mod='hipay_enterprise'}
                <i class="icon-arrow-circle-o-down"></i></a>
        </div>
        <div id="faq__collapseFive" class="panel-collapse collapse">
            <div class="panel-body">
                <ul>
                    <li>{l s='Check that the HiPay Enterprise module is properly set up with your currencies and your carriers in the “Improve > Payment > Preference” menu. When adding a carrier or a currency, you should always activate them in this setup screen.' mod='hipay_enterprise'}
                    </li>
                    <li>{l s='Check in the HiPay module configuration that the payment method(s) is/are enabled for test countries and currencies.' mod='hipay_enterprise'}
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-question">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" aria-expanded="false"
                href="#faq__collapseSix"><i class="icon-question-circle"></i>
                {l s='How come Oney Facily Pay does not work?' mod='hipay_enterprise'}
                <i class="icon-arrow-circle-o-down"></i></a>
        </div>
        <div id="faq__collapseSix" class="panel-collapse collapse">
            <div class="panel-body">
    ...
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-question">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" aria-expanded="false"
                href="#faq__collapseSeven"><i class="icon-question-circle"></i>
                {l s='How can I do a manual capture and refund?' mod='hipay_enterprise'}
                <i class="icon-arrow-circle-o-down"></i></a>
        </div>
        <div id="faq__collapseSeven" class="panel-collapse collapse">
            <div class="panel-body">
