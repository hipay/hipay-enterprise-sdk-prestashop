<div id="hostedconf">
        ...
        <div class="col-lg-2">
            <select name="display_hosted_page" class="" id="display_hosted_page">
                <option value="redirect"
                    {if $HiPay_config_hipay.payment.global.display_hosted_page == "redirect"}selected="selected" {/if}>
                    {l s='Redirect' mod='hipay_enterprise'}</option>
                <option value="iframe"
                    {if $HiPay_config_hipay.payment.global.display_hosted_page == "iframe"}selected="selected" {/if}>
                    {l s='Iframe' mod='hipay_enterprise'}</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-4">
            <input class="form-control" type="text" name="css_url" value="{$HiPay_config_hipay.payment.global.css_url}">
            <p class="help-block">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <div class="row">
                <span class="switch prestashop-switch fixed-width-lg">
                    <input type="radio" name="display_cancel_button" id="display_cancel_button_switchmode_on" value="1"
                        {if $HiPay_config_hipay.payment.global.display_cancel_button }checked="checked" {/if}>
                    <label for="display_cancel_button_switchmode_on">{l s='Yes' mod='hipay_enterprise'}</label>
                    <input type="radio" name="display_cancel_button" id="display_cancel_button_switchmode_off" value="0"
