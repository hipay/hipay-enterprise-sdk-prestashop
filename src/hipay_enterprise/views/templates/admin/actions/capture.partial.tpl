                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-lg-6 input-group">
                                        {if $remainQty > 0}
                                                <input data-unit-price="{$item.unit_price_tax_incl}" class ="good-selector-capture" id="good-selector-{$item["product_id"]}" name="hipaycapture[{$item["product_id"]}]" type="number" min="0"
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    {if $shippingCost > 0 }
                                        {if !$capturedFees}
                                            <input id="capture-fee" data-amount="{$amountFees}" type="checkbox" name="hipay_capture_fee"> {l s='Capture fee(s)' mod='hipay_enterprise'}
                                        {else}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {if !$capturedDiscounts}
                                            <input id="capture-discount" data-amount="{$discount.value}" type="checkbox" name="hipay_capture_discount"> {l s='Capture Discount' mod='hipay_enterprise'}
