...
*}
    ...
    <fieldset>
        ...
        <p><b>{l s='Amount that can be refunded' mod='hipay_enterprise' } :</b> <span class="badge badge-success">{$refundableAmountDisplay}</span></p>
        <p class="help-block">
                                ...
                                <td>
                                    {if $remainQty > 0}
                                        <div class="col-lg-6 input-group">
                                            <input data-unit-price="{$item.unit_price_tax_incl}" class ="good-selector-refund" name="hipayrefund[{$item["product_id"]}]" type="number" min="0"
