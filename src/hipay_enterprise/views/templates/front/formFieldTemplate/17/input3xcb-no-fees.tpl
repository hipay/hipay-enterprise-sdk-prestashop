<div id="oney-versions-3xcb-no-fees"></div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    // Setup event listeners for 3xcb-no-fees
    OneyCommon.setupPaymentMethodChangeListener('3xcb-no-fees');
    OneyCommon.setupPrestaShopListeners('3xcb-no-fees');
  });
</script>
