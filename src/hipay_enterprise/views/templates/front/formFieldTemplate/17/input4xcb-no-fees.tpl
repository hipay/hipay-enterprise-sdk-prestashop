<div id="oney-versions-4xcb-no-fees"></div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    // Setup event listeners for 4xcb-no-fees
    OneyCommon.setupPaymentMethodChangeListener('4xcb-no-fees');
    OneyCommon.setupPrestaShopListeners('4xcb-no-fees');
  });
</script>
