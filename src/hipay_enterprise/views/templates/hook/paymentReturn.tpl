 ...
 *}
{if isset($HiPay_status) && $HiPay_status == 'ok'}
    <h3>{l s='Your order is complete.' mod='hipay_enterprise'}</h3>
    <p>
        <br/>- {l s='Amount' mod='hipay_enterprise'} : <span
                class="price"><strong>{$HiPay_total_to_pay|escape:'htmlall':'UTF-8'}</strong></span>
        <br/>- {l s='Reference' mod='hipay_enterprise'} : <span
                class="reference"><strong>{$HiPay_reference|escape:'htmlall':'UTF-8'}</strong></span>
