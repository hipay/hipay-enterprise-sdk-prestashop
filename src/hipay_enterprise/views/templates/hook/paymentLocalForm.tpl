 ...
 *}
{if ($HiPay_localPaymentName eq "paypal" && (isset($HiPay_PayPal_v2) && $HiPay_PayPal_v2)) OR $HiPay_localPaymentName eq "applepay"}
...
{elseif $HiPay_localPaymentName eq "paypal" && (isset($HiPay_PayPal_v2) && $HiPay_PayPal_v2)}
