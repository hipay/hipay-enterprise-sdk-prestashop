...
sshpass -p $PASS_DEPLOY ssh root@docker-knock-auth.hipay.org -p $port jfrog rt u /deploy/project/artifactory/$CIRCLE_PROJECT_REPONAME/$BRANCH/*.zip "hipay/org.hipay/" \
