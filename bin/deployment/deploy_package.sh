...
sshpass -p $PASS_DEPLOY scp -P $PORT_SSH_DOCKER -o StrictHostKeyChecking=no  package-ready-for-prestashop/hipay-enterprise-sdk-prestashop*.zip root@docker-knock-auth.hipay.org:/deploy/project/artifactory/$CI_JOB_ID
